...
public class LoginActivity extends AppCompatActivity implements
    ...
    private TextView btnGoToForgotPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGoToRegister = (TextView) findViewById(R.id.btn_go_to_register);
        btnGoToForgotPassword = (TextView) findViewById(R.id.btn_go_to_forget_password);
    ...
    private void actionLogin(){
        ...
        btnGoToForgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentRegister = new Intent(LoginActivity.this, ForgotPasswordActivity.class);
                startActivity(intentRegister);
            }
        });
    }
    ...
    private boolean validationEmailAndEmail(String emailAddress, String password) {
        if(!emailAddress.contains("@") || emailAddress.equals("")){
            ...
            if(emailAddress.equals("")){
                ...
                inputLayoutEmailAddress.setError("Not a valid email address!");
            }
            return false;
        }
    ...
    /**
     * handle after user try to login
